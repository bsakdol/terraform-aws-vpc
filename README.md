...
| <a name="input_nat_gateway_tags"></a> [nat\_gateway\_tags](#input\_nat\_gateway\_tags) | A map of tags to assign to the NAT Gateway resources. Resourcespecific tags<br>will override all other tags. | `map(string)` | `{}` | no |
